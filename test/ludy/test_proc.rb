...
class TestProc < Test::Unit::TestCase
  def test_bind
    assert_equal [9,8,7], ([1,2,3].map(&lambda{|lhs, rhs| lhs-rhs}._bind(10, :_1)))
    assert_equal [3,2,1], (lambda{|a,b,c| [a,b,c]}._bind :_3, :_2, :_1)[1,2,3]
    assert_equal [1,9,3], (lambda{|a,b,c| [a,b,c]}._bind :_1, 9, :_3)[1,2,3]
    assert_equal [9,2,3], (lambda{|a,b,c| [a,b,c]}._bind 9)[2,3]
    assert_equal [9,4,2], (lambda{|a,b,c| [a,b,c]}._bind 9, :_3)[2,3,4]
  end
  def test_curry
